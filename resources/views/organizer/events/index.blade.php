...
@section('page_subtitle', 'Buat dan atur acara khusus organisasi Anda.')

@section('content')
<div class="mb-4 text-right">
    <a href="{{ route('organizer.events.create') }}" class="inline-block px-6 py-3 bg-indigo-600 text-white rounded-2xl font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition">
        + Tambah Event Baru
    </a>
</div>
            ...
            <tbody class="divide-y border-t">
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6">
                        ...
                        <p class="text-xs text-slate-400 italic">{{ $event->category->name ?? 'Uncategorized' }} • {{ $event->date->format('d M Y') }}</p>
                    </td>
                    <td class="px-8 py-6">
                    ...
                    <td class="px-8 py-6">
                        <div class="flex justify-center gap-2">
                            <a href="{{ route('organizer.events.edit', $event->id) }}" class="p-2.5 bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition shadow-sm">
