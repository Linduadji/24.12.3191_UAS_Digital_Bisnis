...
class MidtransWebhookController extends Controller
{
    public function handle(Request $request)
    {
        ...
        // Cegah proses berulang jika status sudah settlement/success
        if (in_array($transaction->status, ['settlement', 'success'])) {
            return response()->json(['message' => 'Already processed'], 200);
        }

        // Logika Penerjemahan Status Midtrans API ke Status Lokal (lowercase)
        ...
        // Kembalikan 200 OK agar Midtrans menandai webhook sebagai berhasil
        return response()->json(['message' => 'OK'], 200);
    }

    /**
     * Method processSuccess() untuk penanganan setelah transaksi berhasil
     * Instruksi lanjutan seperti pemotongan tiket akan dibahas pada Modul 13
     */
    ...
    {   
        ...
        // TODO: Implementasi pengurangan stock tiket
        // TODO: Implementasi pengiriman email dengan E-Ticket
    }
}